...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/char.png", __ASSET__assets_char_png);
		//type.set ("assets/char.png", Reflect.field (AssetType, "image".toUpperCase ()));
		type.set ("assets/char.png", AssetType.IMAGE);
		...
		className.set ("assets/haxe.tga", __ASSET__assets_haxe_tga);
		//type.set ("assets/haxe.tga", Reflect.field (AssetType, "binary".toUpperCase ()));
		type.set ("assets/haxe.tga", AssetType.BINARY);
		className.set ("assets/haxe2k.png", __ASSET__assets_haxe2k_png);
		//type.set ("assets/haxe2k.png", Reflect.field (AssetType, "image".toUpperCase ()));
		type.set ("assets/haxe2k.png", AssetType.IMAGE);
		...
		className.set ("assets/Roboto.ttf", __ASSET__assets_roboto_ttf);
		//type.set ("assets/Roboto.ttf", Reflect.field (AssetType, "font".toUpperCase ()));
		type.set ("assets/Roboto.ttf", AssetType.FONT);
		...
		addExternal("assets/haxe.tga", "binary", "assets/haxe.tga");
		addExternal("assets/haxe2k.png", "image", "assets/haxe2k.png");
		...
		addEmbed("assets/Roboto.ttf", "font", __ASSET__assets_roboto_ttf);
...
@:keep class __ASSET__assets_char_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_haxe_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
@:keep class __ASSET__assets_haxe_tga extends flash.utils.ByteArray { }
@:keep class __ASSET__assets_haxe2k_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep class __ASSET__assets_roboto_ttf extends flash.text.Font { }
...
@:keep class __ASSET__assets_roboto_ttf extends flash.text.Font { #if (!openfl_html5_dom) public function new () { super (); fontName = "assets/Roboto.ttf"; } #end }


#elseif (windows || mac || linux)


@:bitmap("assets/char.png") class __ASSET__assets_char_png extends flash.display.BitmapData {}
@:bitmap("assets/haxe.png") class __ASSET__assets_haxe_png extends flash.display.BitmapData {}
@:file("assets/haxe.tga") class __ASSET__assets_haxe_tga extends flash.utils.ByteArray {}
@:bitmap("assets/haxe2k.png") class __ASSET__assets_haxe2k_png extends flash.display.BitmapData {}
...
@:font("assets/Roboto.ttf") class __ASSET__assets_roboto_ttf extends flash.text.Font {}
